      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        {step === 1 && (
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div
              className="border-2 border-dashed border-pink-200 rounded-2xl p-8 text-center hover:border-pink-400 transition cursor-pointer mb-6"
            ...
            >
              {photoPreview ? (
                ...
                <>
                  ...
                  <p className="text-gray-600 font-medium text-lg">사진을 올려주세요</p>
                  <p className="text-sm text-gray-400 mt-2">정면 전신 사진이 가장 좋아요</p>
